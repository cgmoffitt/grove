            ...
            <div className="row align-items-center">
                <div className="col-lg-5">
                    <div className="banner_content wow fadeInLeft" >
                        ...
                        <a href={url} style={{width: 200, marginRight:'5%'}} target='_blank' rel='noopener noreferrer' className="deneb_btn">Try our Med-Fi</a>
                        {/* <a href={url2} style={{width: 200}} target='_blank' rel='noopener noreferrer' className="deneb_btn">Try our High-Fi</a> */}
                    </div>
                </div>
